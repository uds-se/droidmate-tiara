...
object Analyzer {
    ...
    private suspend fun ExplorationContext.compareTo(other: ExplorationContext): Result {
        ...
        if (actionableRatio < 1.0)
            return Result(
                Status.PossibleFunctionalityLoss, reproducibilityRatio,
        ...
        if (observedRatio < 1.0)
            return Result(
                Status.InformationLoss, reproducibilityRatio,
                thisActionableWidgets.size, otherActionableWidgets.size, actionableRatio,
    ...
    private suspend fun confirm(
        ...
        widgetId: UUID,
        api: IApi,
        originalExploration: ExplorationContext
    ): Result {
    ...
    private suspend fun exploreWithEnforcement(
        args: Array<String>,
        originalOutDir: Path,
        widgetId: UUID,
        api: IApi,
